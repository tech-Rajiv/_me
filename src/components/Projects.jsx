...
function Projects() {
  return (
    <div className="projcts py-2 lg:py-1 mt-20 px-5 lg:px-1">
      ...
      <div className="firstPoject mt-8">
        <div className="first flex  flex-col sm:flex-row-reverse mt-5 gap-5 items-center">
          <div className="projectImg shadow-2xl bg-gray-900   w-full sm:max-w-58 rounded-2xl overflow-hidden ">
            <img
          ...
          <div className="Info ">
            <h1 className="text-teal-500 font-bold text-lg flex items-baseline">
              <span>
        ...
        <div className="links mt-4 text-base text-teal-500   flex justify-between sm:justify-end items-center">
      ...
      <div className="SecondPoject mt-14">
        <div className="first flex  flex-col sm:flex-row mt-5 gap-5 items-center">
          <div className="projectImg shadow-2xl bg-gray-900    w-full sm:max-w-64 rounded-2xl overflow-hidden ">
            <img
