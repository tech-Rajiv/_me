...
function AboutShort() {
  return (
    <section id="aboutMe" className=" py-2 lg:py-1 mt-20 px-5 lg:px-1">
      ...
      <div className="border border-gray-300 px-2 rounded-lg py-2 mt-4">
        <div className="flex justify-between items-center">
          <div>
            <i className="ri-graduation-cap-line text-teal-500"></i>{" "}
            <span className="text-teal-500 font-semibold">MCA</span>
            <i>
        ...
        <div className="mt-3 flex justify-between items-center">
          <div>
            <i className="ri-graduation-cap-line text-teal-500"></i>{" "}
            <span className="text-teal-500 font-semibold">BSC</span>
            <i>
      ...
      <p className="text-gray-300 mt-4">
        Hi, I'm Rajiv, a self-taught developer who transitioned from a different
        career to software development over the past year. With a solid
        foundation in JavaScript and React, my journey in tech is fueled by
        continuous learning
      </p>
    </section>
  );
