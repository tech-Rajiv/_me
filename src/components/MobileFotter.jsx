  ...
  return (
    ...
    <div className="flex flex-col md:flex-row gap-4 mt-5  md:justify-between  text-teal-500 text-xl">
      ...
      <a href="mailto:999rajivmishra@gmail.com">
        <p className="links3  flex items-baseline">Gmail <i className="ri-arrow-right-up-line"></i></p></a>

      

      <a href="https://www.instagram.com/rajiv.007">
        <p className="links3 flex items-baseline">Instagram <i className="ri-arrow-right-up-line"></i></p></a>
      <a href="https://github.com/tech-Rajiv">
        <p className="links3 flex items-baseline">Github <i className="ri-arrow-right-up-line"></i></p> </a>
      <a href="">
        <p className="links3 flex items-baseline">Linkedin <i className="ri-arrow-right-up-line"></i></p></a>
      <a href="">
        <p className="links3 flex items-baseline">X <i className="ri-arrow-right-up-line"></i></p> </a>
    </div>
